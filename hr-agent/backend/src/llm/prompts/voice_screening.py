...
VOICE_SCREEN_EVAL_VERSION = "v2"


VOICE_SCREEN_GEN_V1 = """You design a SHORT spoken phone-screen for ONE candidate applying to ONE role.
...
VOICE_SCREEN_EVAL_V1 = """You evaluate a phone-screen transcript answer-by-answer for ONE candidate.
